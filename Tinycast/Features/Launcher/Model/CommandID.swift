...
enum CommandID: String, CaseIterable, Sendable {
    ...
    case searchSFSymbols = "command:search-sf-symbols"
    case pickColor = "command:pick-color"
    case colorHistory = "command:color-history"
    case searchFiles = "command:search-files"
    case manageProcesses = "command:manage-processes"
    case reminders = "command:reminders"
    case createReminder = "command:create-reminder"
    ...
    var name: String {
        ...
        case .searchSFSymbols: return "Search SF Symbols"
        case .pickColor: return "Pick Color"
        case .colorHistory: return "Color History"
        case .searchFiles: return "Search Files"
        case .manageProcesses: return "Manage Processes"
